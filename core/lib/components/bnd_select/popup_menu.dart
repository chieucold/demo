...
class PopupMenuItemState<T, W extends CustomPopupMenuItem<T>> extends State<W> {
  ...
  Widget build(BuildContext context) {
    ...
    final TextStyle? style = widget.textStyle ?? popupMenuTheme.textStyle ?? theme.textTheme.subtitle1;
...
/// summing the values of [CustomPopupMenuEntry._height] for all the preceding widgets
/// in the list.
///
