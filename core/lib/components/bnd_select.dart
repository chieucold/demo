...
class BNDSelect<T> extends FormBuilderField<T> {
  ...
  BNDSelect({
    ...
    this.selectedItemBuilder,
          ...
          builder: (FormFieldState<T?> field) {
            final _BNDSelectState<T> state = field as _BNDSelectState<T>;
  ...
  @override
  _BNDSelectState<T> createState() => _BNDSelectState<T>();
}

class _BNDSelectState<T> extends FormBuilderFieldState<BNDSelect<T>, T> {}
