...
/// On/Off switch field
class BNDSwitch extends FormBuilderField<bool> {
  ...
  BNDSwitch({
    ...
    this.selected = false,
          ...
          builder: (FormFieldState<bool?> field) {
            final state = field as _BNDSwitchState;
  ...
  @override
  _BNDSwitchState createState() => _BNDSwitchState();
}

class _BNDSwitchState extends FormBuilderFieldState<BNDSwitch, bool> {}
