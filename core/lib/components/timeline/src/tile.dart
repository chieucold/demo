...
import 'package:core/components/timeline/src/axis.dart';
import 'package:core/components/timeline/src/style.dart';
...
class _Indicator extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final _TimelinePainter painter = _TimelinePainter(
      axis: axis,
      beforeLineStyle: beforeLineStyle,
      afterLineStyle: afterLineStyle,
      indicatorStyle: indicatorStyle,
...
class _TimelinePainter extends CustomPainter {
  ...
  void _drawAfterLine(Canvas canvas, double centerAxis, AxisPosition position) {
    ...
    final lineSize =
        axis == TimelineAxis.vertical ? endBottomLine.dy - beginBottomLine.dy : endBottomLine.dx - beginBottomLine.dx;
    // if the line size is less or equal than 0, the line shouldn't be rendered
    if (lineSize > 0) {
      canvas.drawLine(beginBottomLine, endBottomLine, afterLinePaint);
    }
