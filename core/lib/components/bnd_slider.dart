...
class BNDSlider extends FormBuilderField<double> {
  ...
  BNDSlider({
    ...
    this.mouseCursor,
          ...
          builder: (FormFieldState<double?> field) {
            final _BNDSliderState state = field as _BNDSliderState;
            final NumberFormat _numberFormat = numberFormat ?? NumberFormat.compact();
  ...
  @override
  _BNDSliderState createState() => _BNDSliderState();
}

class _BNDSliderState extends FormBuilderFieldState<BNDSlider, double> {}
