...
class ListEventHappeningWidget extends StatefulWidget {
  final EventEnum eventEnum;
  const ListEventHappeningWidget({Key? key, required this.eventEnum}) : super(key: key);

  @override
  State<ListEventHappeningWidget> createState() => _ListEventHappeningWidgetState();
}

class _ListEventHappeningWidgetState extends State<ListEventHappeningWidget> with AutomaticKeepAliveClientMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider<VEO2ListEventBloc>(
        create: (BuildContext context) => _bloc..refresh(VEO2TabTypeEnum.happening, widget.eventEnum),
        child: BlocBuilder<VEO2ListEventBloc, VEO2ListEventState>(
          ...
          if (state is VEO2ListEventLoading) {
            ...
            return CustomListView<EventPublicResource>(
              ...
              items: model.happening,
              onRefresh: () {
                _bloc.refresh(VEO2TabTypeEnum.happening, widget.eventEnum);
              },
