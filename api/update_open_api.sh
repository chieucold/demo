...
curl -s http://117.4.243.193:8087/swagger/v1/swagger.json -o ./lib/api/payment_auto_api.json
curl -s http://117.4.243.193:8088/api/event/swagger/v1/swagger.json -o ./lib/api/event_api.json
